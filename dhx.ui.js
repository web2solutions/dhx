...
$dhx.ui = {
	...
	, start: function (c) {
		...
		else if (window.location.host.indexOf('juris.web2.eti.br') != -1) {
			//alert()
			$dhx.environment = "test";
			$dhx.ui.cdn_address = '//juris.web2.eti.br/';
		}
		...
		if (c.dhtmlx) {
			if (typeof window.dhx4 === 'undefined') {
				...
				deps.push($dhx.ui.cdn_address + "dhx/dhx.excells.js");
		...
		deps.push($dhx.ui.cdn_address + "dhx/dhx.ui.viewer.js");
		...
		deps.push($dhx.ui.cdn_address + "dhx/dhx.ui.desktop.plugins.js");
		...
		core_deps.push($dhx.ui.cdn_address + "dhx/dhx.ui.form.js");
	...
	,columnTypesBySQL: function ($sql_type) {
		if ($sql_type == 'integer') {
			...
			return [
				...
				,{ value : 'calck', text : 'calculator' }
				,{ value : 'UScurrency', text : 'US currency' }
				,{ value : 'BRcurrency', text : 'BR currency' }
				//
			];
		}
		else if ($sql_type == 'character varying') {
			return [
				...
				//,{ value : 'clist', text : 'checkbox list' }
				,{ value : 'USphone', text : 'US phone' }
				,{ value : 'BRphone', text : 'BR phone' }
				,{ value : 'ssn', text : 'SSN' }
				,{ value : 'cpf', text : 'CPF' }
				,{ value : 'cep', text : 'CEP' }
			...
			return [
				{ value : 'ch', text : 'checkbox' }
				,{ value : 'ro', text : 'read only' }
				,{ value : 'acheck', text : 'skinnable checkbox' }
			];
		}else
