...
$dhx.ui.desktop.view.ControlPanel = {
	...
	, _preview_wallpaper: function () {
		...
		{
			self.bmonitor.style.backgroundPosition = 'center center';
			self.bmonitor.style.backgroundSize = $dhx.ui.desktop.user_settings.wallpaperposition;
		}
		else
		{
			self.bmonitor.style.backgroundPosition = $dhx.ui.desktop.user_settings.wallpaperposition;
			self.bmonitor.style.backgroundSize = '700px';
		}
	...
	, _toolbar_wallpapers: function (schema) {
		...
		self.toolbar_wallpapers.attachEvent("onClick", function (id) {
			...
			if( id == 'save')
			{
				schema.desktop_config.update(
					...
					, {
						...
						,wallpaperposition : self.toolbar_wallpapers.getListOptionSelected('wallpaperposition')
					}
					, {
			...
			if( id != 'wallpaperposition' && id != 'save'  )
			{
				this.enableItem('save');
				
				self.temporaryWallpaper = $dhx.ui.desktop.user_settings.wallpaper;
				
				$dhx.ui.desktop.user_settings.wallpaperposition = self.toolbar_wallpapers.getListOptionSelected('wallpaperposition');
				...
				if ($dhx.ui.desktop.user_settings.wallpaperposition == 'cover') {
					...
					self.bmonitor.style.backgroundPosition = $dhx.ui.desktop.user_settings.wallpaperposition;
					self.bmonitor.style.backgroundSize = '432px';
				}
			}
		 ...
		 // $dhx.ui.desktop.user_settings.wallpaperposition
		 
		 self.toolbar_wallpapers.setListOptionSelected('wallpaperposition', $dhx.ui.desktop.user_settings.wallpaperposition);
	}
